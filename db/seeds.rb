...
u2 = User.create(first_name: 'Aurélie', last_name: 'Rix', email: 'mathil.robert@gmail.com', password: 'testtest', admin: false)
u3 = User.create(first_name: 'Paula', last_name: 'Richeux', email: 'contact@mathilderobert.com', password: 'testtest', admin: false)
